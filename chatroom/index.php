	...
	<body>
		<section data-role="page" id="index">
			<div data-role="panel" id="chatroom" data-position="left"> 
				<h2>聊天室設定</h2>
				<span>
					<label for="fname" class="ui-hidden-accessible">websocket：</label>
					<input type="text" name="websocket" value="ws://ws-event.vidol.tv:8080/barrage" placeholder="websocket位置...">
				</span>
				<span>
