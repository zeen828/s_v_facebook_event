...
<html>
  <head>
    ...
    <meta name="description" content="三立新八點華劇《獨家保鑣》來囉！四位演員謝佳見、黃薇渟、洪小鈴、孫沁岳將在劇中演出保鑣與記者間，的既是敵人又發展出愛情的浪漫故事。" />
    <meta name="keywords" content="直播, 獨家保鑣, 新聞, 獨家, live" />
    <meta property="og:title" content="special -《獨家保鑣》卡司發佈會 - Vidol, Sanlih E-Television Co., Ltd.">
    <meta property="og:description" content="三立新八點華劇《獨家保鑣》來囉！四位演員謝佳見、黃薇渟、洪小鈴、孫沁岳將在劇中演出保鑣與記者間，的既是敵人又發展出愛情的浪漫故事。">
    ...
    <title> special - 獨家保鑣 Live - Vidol, Sanlih E-Television Co., Ltd.</title>
  ...
  <body>
    ...
    <article class="content">
	 ...
	 <div class="top" switch="ture">
        ...
        <span class="img" pc="images/kv/kv_pc.jpg" pad="images/kv/kv_pad.jpg" mobile="images/kv/kv_mobile.jpg" alt="test" title="獨家保鑣" url=""></span>
      </div>
...
<?php
    ...
    case 'youtube':
?>
          <iframe width="560" height="315" src="http://special.vidol.tv/SET_DEV/index.html" frameborder="0" allowfullscreen></iframe>
<?php
        break;
    case 'brightcove':
?>
...
?>
        ...
        <div class="con">
          ...
          <div class="bannerAll" switch="true">
            <ul class="bannerUl">
              <li size="728x90">
					<!-- Vidol_web_board_728 -->
					<ins class="adsbygoogle"
						 style="display:inline-block;width:728px;height:90px"
						 data-ad-client="ca-pub-7814187131968622"
						 data-ad-slot="7484390592"></ins>
					<script>
					(adsbygoogle = window.adsbygoogle || []).push({});
					</script>
			   </li>
              <li size="468x60 pad">
					<!-- /123939770/Vidol_web_board_468 -->
					<div id='div-gpt-ad-1472642594193-1' style='height:60px; width:468px;'>
					<script>
					googletag.cmd.push(function() { googletag.display('div-gpt-ad-1472642594193-1'); });
					</script>
					</div>
				</li>
              <li size="320X50">
					<!-- /123939770/Vidol_web_board_320 -->
					<div id='div-gpt-ad-1472642594193-0' style='height:50px; width:320px;'>
					<script>
					googletag.cmd.push(function() { googletag.display('div-gpt-ad-1472642594193-0'); });
					</script>
					</div>
				</li>
            </ul>
          ...
          <h2>《獨家保鑣》卡司發佈會 </h2>
          <p>
            三立新八點華劇《獨家保鑣》來囉！四位演員謝佳見、黃薇渟、洪小鈴、孫沁岳將在劇中演出保鑣與記者間，的既是敵人又發展出愛情的浪漫故事。
          </p>
        </div>
      </div>
